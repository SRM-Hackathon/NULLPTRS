package com.app.storey.connection;

import com.app.storey.connection.callbacks.CallbackCategory;
import com.app.storey.connection.callbacks.CallbackDevice;
import com.app.storey.connection.callbacks.CallbackFeaturedNews;
import com.app.storey.connection.callbacks.CallbackInfo;
import com.app.storey.connection.callbacks.CallbackNewsInfo;
import com.app.storey.connection.callbacks.CallbackNewsInfoDetails;
import com.app.storey.connection.callbacks.CallbackOrder;
import com.app.storey.connection.callbacks.CallbackProduct;
import com.app.storey.connection.callbacks.CallbackProductDetails;
import com.app.storey.data.Constant;
import com.app.storey.model.Checkout;
import com.app.storey.model.DeviceInfo;
