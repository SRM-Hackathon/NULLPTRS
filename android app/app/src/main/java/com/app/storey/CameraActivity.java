...
public class CameraActivity extends AppCompatActivity implements View.OnClickListener {
   ...
   /* private void captureVideo() {
    ...
    private void setUpMenu() {
        ...
        itemProfile  = new ResideMenuItem(this, R.drawable.icon_profile,  "LOGOUT");
        itemCalendar = new ResideMenuItem(this, R.drawable.icon_home, "HOME");
        itemSettings = new ResideMenuItem(this, R.drawable.icon_profile, "LOGOUT");
